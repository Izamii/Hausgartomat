...
/**
 * Class with multiple specific navigation methods to open
...
public class GoToScreen : MonoBehaviour
{
    ...
    /**
     * <summary>Go to Plant Detail Screen of specified plant</summary>
    ...
    /**
     * <summary> Opens the last screen to the actual one.</summary>
     ...
     * <param name="thisScreen">The actual opened screen</param>
     * */
